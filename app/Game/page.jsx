...
export default function Game() {
	...
	const L = () => {
		for (let i = 0; i < boardLength ** 2; i++) {
			if (
				i % boardLength < boardLength - 2 &&
				board[i + 1] &&
				board[i + 2] &&
				board[i + boardLength] &&
				board[i + 2 * boardLength] &&
				board[i - 1] &&
	...
	const row5 = () => {
		for (let i = 0; i < boardLength ** 2; i++) {
			if (
				i % boardLength === boardLength - 1 ||
				i % boardLength === boardLength - 2 ||
				i % boardLength === boardLength - 3 ||
				i % boardLength === boardLength - 4
			)
				continue;
			if (
				board[i].name === board[i + 1].name &&
			...
			if (
				...
				setBoard((prevBoard) => {
					...
					if (firstSquare.current === null && endSquare.current === null) {
						...
						if (
							parseInt(firstSquare.current.getAttribute('data-gameid')) === i ||
							parseInt(endSquare.current.getAttribute('data-gameid')) === i
						)
							newBoard[i] = pineapple;
						else if (
							parseInt(firstSquare.current.getAttribute('data-gameid')) ===
								i + 1 ||
							parseInt(endSquare.current.getAttribute('data-gameid')) === i + 1
						)
							newBoard[i + 1] = pineapple;
						else if (
							parseInt(firstSquare.current.getAttribute('data-gameid')) ===
								i + 2 ||
							parseInt(endSquare.current.getAttribute('data-gameid')) === i + 2
						)
							newBoard[i + 2] = pineapple;
						else if (
							parseInt(firstSquare.current.getAttribute('data-gameid')) ===
								i + 3 ||
							parseInt(endSquare.current.getAttribute('data-gameid')) === i + 3
						)
							newBoard[i + 3] = pineapple;
				...
				setBoard((prevBoard) => {
					...
					if (firstSquare.current === null && endSquare.current === null) {
						...
						if (
							...
							parseInt(firstSquare.current.getAttribute('data-gameid')) ===
								i + boardLength ||
							parseInt(endSquare.current.getAttribute('data-gameid')) ===
								i + boardLength
						)
							newBoard[i + boardLength] = pineapple;
						else if (
							parseInt(firstSquare.current.getAttribute('data-gameid')) ===
								i + 2 * boardLength ||
							parseInt(endSquare.current.getAttribute('data-gameid')) ===
							...
							newBoard[i + 2 * boardLength] = pineapple;
						else if (
							parseInt(firstSquare.current.getAttribute('data-gameid')) ===
								i + 3 * boardLength ||
							parseInt(endSquare.current.getAttribute('data-gameid')) ===
							...
							newBoard[i + 3 * boardLength] = pineapple;
						else newBoard[i] = pineapple;
					}
					return newBoard;
				});
	...
	const checkBoard = () => {
		...
		if (swapped.current) {
			...
			setBoard((prevBoard) => {
				const newBoard = [...prevBoard];
				newBoard[endSquare.current.getAttribute('data-gameid')] =
					prevBoard[firstSquare.current.getAttribute('data-gameid')];
				newBoard[firstSquare.current.getAttribute('data-gameid')] =
					prevBoard[endSquare.current.getAttribute('data-gameid')];
				return newBoard;
			});
			swapped.current = false;
		}
	...
	const pineapple1 = (id) => {
		...
		verticalRef.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.375 * imageWidth.current
		}px`;
		horizontalRef.current.style.visibility = 'visible';
		isAnimation.current = true;
		horizontalRef.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.375 * imageWidth.current
		}px`;
	...
	const pineapple2 = (id) => {
		...
		horizontalRef.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.3125 * imageWidth.current
		}px`;
		rotated45Ref.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.4 * imageWidth.current
		}px`;
		rotated135Ref.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.75 * imageWidth.current
		}px`;
		rotated225Ref.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.25 * imageWidth.current
		}px`;
		rotated315Ref.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.625 * imageWidth.current
		}px`;
		rotated45Ref.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.325 * imageWidth.current
		}px`;
		rotated135Ref.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.5 * imageWidth.current
		}px`;
		rotated225Ref.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.5 * imageWidth.current
		}px`;
		rotated315Ref.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.625 * imageWidth.current
		}px`;
		isAnimation.current = true;
		setTimeout(() => makeInvisible(verticalRef.current), animationDuration);
		setTimeout(() => makeInvisible(horizontalRef.current), animationDuration);
	...
	const explosion = (id) => {
		...
		explosionRef.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.12 * imageWidth.current
		}px`;
		explosionRef.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.12 * imageWidth.current
		}px`;
		isAnimation.current = true;
	...
	const explosion2 = (id) => {
		...
		explosion2Ref.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.12 * imageWidth.current
		}px`;
		explosion2Ref.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.12 * imageWidth.current
		}px`;
		isAnimation.current = true;
	...
	const pineappleExplosion = (id) => {
		...
		pineappleExplosionVerticalRef.current.style.left = `${
			(id % boardLength) * imageWidth.current + 0.37 * imageWidth.current
		}px`;
		pineappleExplosionHorizontalRef.current.style.visibility = 'visible';
		pineappleExplosionHorizontalRef.current.style.top = `${
			Math.floor(id / boardLength) * imageWidth.current +
			0.37 * imageWidth.current
		}px`;
		isAnimation.current = true;
		setTimeout(
			() => makeInvisible(pineappleExplosionHorizontalRef.current),
			animationDuration
		);
		setTimeout(
			() => makeInvisible(pineappleExplosionVerticalRef.current),
			animationDuration
		);
	};
	const lightningTime = (id, endId) => {
		...
		boltsRef.current[endId].style.left = `${
			x1 * imageWidth.current + 0.5 * imageWidth.current
		}px`;
		boltsRef.current[endId].style.top = `${
			y1 * imageWidth.current + 0.5 * imageWidth.current
		}px`;
		boltsRef.current[endId].style.height = `${
			Math.sqrt((x2 - x1) ** 2 + (y2 - y1) ** 2) * imageWidth.current
		}px`;
	...
	const handleEnd = () => {
		...
		if (moves.current <= 0) return;
		if (
			endSquare.current === null ||
			firstSquare.current === null ||
			endSquare.current === undefined ||
			firstSquare.current === undefined
		)
			return;
		...
		if (
			(isNeighbour !== boardLength && isNeighbour !== 1) ||
			(isNeighbour === 1 &&
				((lId % boardLength === 0 && fId % boardLength === boardLength - 1) ||
					(fId % boardLength === 0 && lId % boardLength === boardLength - 1)))
		)
			return;
		setBoard((prevBoard) => {
			const newBoard = [...prevBoard];
			if (
				endSquare.current.name === 'Watermelon' &&
				firstSquare.current.name !== 'Watermelon' &&
				firstSquare.current.name !== 'Bomb' &&
				firstSquare.current.name !== 'Pineapple'
			) {
				increment(150);
				moves.current--;
				for (let i = 0; i < boardLength ** 2; i++) {
				...
				firstSquare.current.name === 'Watermelon' &&
				endSquare.current.name !== 'Watermelon' &&
				endSquare.current.name !== 'Bomb' &&
				endSquare.current.name !== 'Pineapple'
			) {
				increment(150);
				moves.current--;
				for (let i = 0; i < boardLength ** 2; i++) {
				...
				if (prevBoard[fId - 1])
					if ((fId - 1) % boardLength !== boardLength - 1) {
						newBoard[fId - 1] = blank;
						increment(10);
					}
				if (prevBoard[fId + 1])
					if ((fId + 1) % boardLength !== 0) {
						newBoard[fId + 1] = blank;
						increment(10);
					}
				if (prevBoard[fId + boardLength]) {
					newBoard[fId + boardLength] = blank;
					increment(10);
				}
				if (prevBoard[fId - boardLength]) {
					newBoard[fId - boardLength] = blank;
				...
				if (prevBoard[fId + boardLength + 1])
					if ((fId + boardLength + 1) % boardLength !== 0) {
						newBoard[fId + boardLength + 1] = blank;
						increment(10);
					}
				if (prevBoard[fId + boardLength - 1])
					if ((fId + boardLength - 1) % boardLength !== boardLength - 1) {
						newBoard[fId + boardLength - 1] = blank;
						increment(10);
					}
				if (prevBoard[fId - boardLength - 1])
				...
				if (prevBoard[lId - 1])
					if ((lId - 1) % boardLength !== boardLength - 1) {
						newBoard[lId - 1] = blank;
						increment(10);
					}
				if (prevBoard[lId + 1])
					if ((lId + 1) % boardLength !== 0) {
						newBoard[lId + 1] = blank;
						increment(10);
					}
				if (prevBoard[lId + boardLength]) {
					newBoard[lId + boardLength] = blank;
					increment(10);
				}
				if (prevBoard[lId - boardLength]) {
					newBoard[lId - boardLength] = blank;
				...
				if (prevBoard[lId + boardLength + 1])
					if ((lId + boardLength + 1) % boardLength !== 0) {
						newBoard[lId + boardLength + 1] = blank;
						increment(10);
					}
				if (prevBoard[lId + boardLength - 1])
					if ((lId + boardLength - 1) % boardLength !== boardLength - 1) {
						newBoard[lId + boardLength - 1] = blank;
						increment(10);
					}
				if (prevBoard[lId - boardLength - 1])
				...
				for (let i = 0; i < boardLength ** 2; i++) {
					if (
						i % boardLength === lId % boardLength ||
						Math.floor(i / boardLength) === Math.floor(lId / boardLength)
					) {
						newBoard[i] = blank;
						increment(10);
					}
				...
				for (let i = 0; i < boardLength ** 2; i++) {
					if (
						i % boardLength === fId % boardLength ||
						Math.floor(i / boardLength) === Math.floor(fId / boardLength)
					) {
						newBoard[i] = blank;
						increment(10);
					}
				...
				for (let i = 0; i < boardLength ** 2; i++) {
					if (
						i % boardLength === lId % boardLength ||
						Math.floor(i / boardLength) === Math.floor(lId / boardLength) ||
						i % boardLength === (lId % boardLength) - 1 ||
						Math.floor(i / boardLength) === Math.floor(lId / boardLength) - 1 ||
						i % boardLength === (lId % boardLength) + 1 ||
						Math.floor(i / boardLength) === Math.floor(lId / boardLength) + 1
					) {
						newBoard[i] = blank;
				...
				if (prevBoard[lId - 2])
					if (
						(lId - 2) % boardLength !== boardLength - 1 &&
						(lId - 2) % boardLength !== 6
					) {
						newBoard[lId - 2] = blank;
						increment(10);
					}
				if (prevBoard[lId + 2])
					if ((lId + 2) % boardLength !== 0 && (lId + 2) % boardLength !== 1) {
						newBoard[lId + 2] = blank;
						increment(10);
					}

				if (prevBoard[lId + 2 * boardLength]) {
					newBoard[lId + 2 * boardLength] = blank;
					increment(10);
				}
				if (prevBoard[lId - 2 * boardLength]) {
					newBoard[lId - 2 * boardLength] = blank;
				...
				if (prevBoard[lId + boardLength + 2])
					if (
						(lId + boardLength + 2) % boardLength !== 0 &&
						(lId + boardLength + 2) % boardLength !== 1
					) {
						newBoard[lId + boardLength + 2] = blank;
						increment(10);
					}
				if (prevBoard[lId + boardLength - 2])
					if (
						(lId + boardLength - 2) % boardLength !== boardLength - 1 &&
						(lId + boardLength - 2) % boardLength !== 6
					) {
						newBoard[lId + boardLength - 2] = blank;
						increment(10);
					}
				...
				if (prevBoard[lId + 2 * boardLength + 1])
					if ((lId + 2 * boardLength + 1) % boardLength !== 0) {
						newBoard[lId + 2 * boardLength + 1] = blank;
						increment(10);
					}
				if (prevBoard[lId + 2 * boardLength - 1])
					if ((lId + 2 * boardLength - 1) % boardLength !== boardLength - 1) {
						newBoard[lId + 2 * boardLength - 1] = blank;
						increment(10);
					}
				if (prevBoard[lId - 2 * boardLength - 1])
				...
				if (prevBoard[lId + 2 * boardLength + 2])
					if (
						(lId + 2 * boardLength + 2) % boardLength !== 0 &&
						(lId + 2 * boardLength + 2) % boardLength !== 1
					) {
						newBoard[lId + 2 * boardLength + 2] = blank;
						increment(10);
					}
				if (prevBoard[lId + 2 * boardLength - 2])
					if (
						(lId + 2 * boardLength - 2) % boardLength !== boardLength - 1 &&
						(lId + 2 * boardLength - 2) % boardLength !== 6
					) {
						newBoard[lId + 2 * boardLength - 2] = blank;
						increment(10);
					}
				...
				for (let i = 0; i < boardLength ** 2; i++) {
					...
					if (
						temp1 === lId % boardLength ||
						temp2 === Math.floor(lId / boardLength) ||
						Math.abs(temp1 - (lId % boardLength)) ===
							Math.abs(temp2 - Math.floor(lId / boardLength))
					) {
						newBoard[i] = blank;
						increment(10);
					}
		...
		<div className={styles.container}>
				...
				<nav className={styles.navbar}>
					<div className={styles.left}>
						<h1 className={styles.score}>
							{windowLoaded.current && sessionStorage.getItem('nickname')}
						</h1>
			...
			<div className={styles.game}>
				...
				{!loading && (
					<>
						...
						<div
							ref={pineappleExplosionHorizontalRef}
							className={styles.pineappleExplosionHorizontal}
						/>
						<div
							ref={pineappleExplosionVerticalRef}
							className={styles.pineappleExplosionVertical}
						/>
					</>
				)}
				{!loading &&
			...
			{!loading && (
				<div className={styles.menu}>
					<button onClick={reset} className={styles.refresh}>
						Refresh
					</button>
					<Link href="/Menu" className={styles.quit}>
						Quit
					</Link>
				</div>
			)}
